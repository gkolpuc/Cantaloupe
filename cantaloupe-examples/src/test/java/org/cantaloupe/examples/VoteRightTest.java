...
public class VoteRightTest {
	...
	public void shouldHaveProperEventName() throws UnirestException, IOException {
		Assert.assertTrue(TestStatus.Success == Cantaloupe.json(ES.urlSearch("_id:171269957492").asJson())
				.getArray("hits.hits").first().getStringVal("_source.Event.DistinguishingEventName")
